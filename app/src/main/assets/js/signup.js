function checkDuplicate() {
    ...
    // 아이디 중복 확인 API 엔드포인트 수정
        axios
          .post("http://43.201.10.121:3000/users/check-duplicate", {
            userid: id,
        })
        .then((response) => {
  ...
  function submit() {
    ...
    axios
      .post("http://43.201.10.121:3000/users/signup", { // URL 수정
        userid: id,
        pw: pw_1,
        email: email,
      })
  ...
  function emailsubmit() {
    ...
    // 아이디 중복 확인 API 엔드포인트 수정
    axios
    .post("http://43.201.10.121:3000/users/certificate", {
      email: email,
      authCode : authCode
    })
    .then((response) => {
  ...
  function checkAuthCode() {
    ...
    axios
      .post("http://43.201.10.121:3000/users/check-auth-code", {
        email: email,
        code: authCode,
      })
      .then((response) => {
